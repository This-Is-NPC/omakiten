...
* **per-preset methodologies — product discipline + PDCA mapping:** `okt-imagine` interrogates via 5W2H + SMART, `okt-create` runs INVEST + MoSCoW/RICE; the eight `okt-*` commands map to Plan-Do-Check-Act. New `product-owner` persona, seven new product-discipline laws, eight new skills, six new comment templates.
