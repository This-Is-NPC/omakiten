...
| FR-018 | Launch TUI with five views: BOARD, TABLE, GRAPH, CONFIG, LOGS | `internal/cli/tui.go`, `internal/tui/state.go:viewNames`, `internal/tui/model.go`, `internal/tui/render_board.go`, `internal/tui/render_table.go`, `internal/tui/render_graph.go`, `internal/tui/render_config.go`, `internal/tui/render_logs.go` |
...
| FR-043 | Expose MCP tools `templates.list` and `templates.show`: read-only template catalog | `internal/agent/service_templates.go`, `internal/mcp/adapter.go` |
