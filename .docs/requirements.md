...
| NFR-012 | Schema migrations applied transactionally with version tracking | `internal/sqlite/store.go`, `migrations/migrations.go`, `migrations/001_initial.sql`–`migrations/014_workflow_defaults.sql` |
