...
- User-facing guides live under `.docs/<topic>-guide.md` (`cli-guide`, `tui-guide`, `mcp-guide`, `configuration-guide`, `guards-guide`, `theming-guide`, `workflow-guide`) plus flat reference docs (`domain-events.md`, `hooks.md`, `notifications.md`).
