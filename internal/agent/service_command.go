...
var commandDescriptions = map[string]string{
	...
	"okt-task-continue":     "Read a task's checkpoint before resuming work.",
	"okt-task-implement":    "Execute approved implementation work with strict rigor and commit discipline.",
