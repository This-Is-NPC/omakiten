...
description: Gather current project state, populate the note-handoff template, and persist a project-scoped handoff note so the next traveller resumes without re-deriving the road.
schema_version: 2
role_affinity:
  - Scribe
  - Concierge
